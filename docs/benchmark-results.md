...
Generated: 2026-02-27 19:23:32 UTC  
Node: v22.14.0  
...
| Photo-heavy (lossless) | 380.0 KB | 378.2 KB | 0.5% | 18ms |
| Photo-heavy (lossy q=75) | 380.0 KB | 30.9 KB | 91.9% | 69ms |
| Photo-heavy (lossy q=75, 150dpi) | 380.0 KB | 23.0 KB | 93.9% | 52ms |
| Tagged accessible PDF | 5.8 KB | 1.2 KB | 79.8% | 4ms |
...
| Kitchen sink (lossy q=75) | 156.0 KB | 20.0 KB | 87.2% | 35ms |
...
**Input:** 380.0 KB | **Output:** 378.2 KB | **Saved:** 0.5% (1.8 KB) | **Time:** 18ms
**Detected traits:** None
...
**Input:** 380.0 KB | **Output:** 30.9 KB | **Saved:** 91.9% (349.1 KB) | **Time:** 69ms
**Detected traits:** None
...
| Recompressing images | 4 converted | 59ms |
| Unembedding standard fonts | 0 unembedded | 0ms |
...
| Recompressing images | 4 converted, 1 downsampled | 41ms |
| Unembedding standard fonts | 0 unembedded | 0ms |
| Subsetting fonts | 0 subsetted | 0ms |
| Deduplicating objects | 0 deduplicated | 0ms |
| Deduplicating fonts | 0 deduplicated | 0ms |
...
**Input:** 5.8 KB | **Output:** 1.2 KB | **Saved:** 79.8% (4.7 KB) | **Time:** 4ms
...
**Input:** 156.0 KB | **Output:** 20.0 KB | **Saved:** 87.2% (136.0 KB) | **Time:** 35ms
**Detected traits:** Tagged, StructTree, Lang=en-US
...
| Recompressing images | 2 converted | 27ms |
| Unembedding standard fonts | 4 unembedded | 0ms |
| Subsetting fonts | 0 subsetted | 0ms |
