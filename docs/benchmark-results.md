...
Generated: 2026-02-27 12:10:43 UTC  
Node: v22.14.0  
...
|-----------|-------|--------|-------|------|
| Illustrator-style bloat | 13.4 KB | 1.2 KB | 90.9% | 13ms |
| Photo-heavy (lossless) | 380.0 KB | 378.2 KB | 0.5% | 19ms |
| Photo-heavy (lossy q=75) | 380.0 KB | 30.9 KB | 91.9% | 74ms |
| Photo-heavy (lossy q=75, 150dpi) | 380.0 KB | 23.0 KB | 93.9% | 65ms |
...
| Kitchen sink (lossless) | 156.0 KB | 139.7 KB | 10.4% | 8ms |
| Kitchen sink (lossy q=75) | 156.0 KB | 20.0 KB | 87.2% | 37ms |

## Illustrator-style bloat

**Input:** 13.4 KB | **Output:** 1.2 KB | **Saved:** 90.9% (12.2 KB) | **Time:** 13ms
...
**Input:** 380.0 KB | **Output:** 30.9 KB | **Saved:** 91.9% (349.1 KB) | **Time:** 74ms
**Detected traits:** None
...
**Input:** 380.0 KB | **Output:** 23.0 KB | **Saved:** 93.9% (356.9 KB) | **Time:** 65ms
**Detected traits:** None
...
| Recompressing images | 4 converted, 1 downsampled | 48ms |
| Unembedding standard fonts | 0 unembedded | 0ms |
| Subsetting fonts | 0 subsetted | 0ms |
| Deduplicating objects | 0 deduplicated | 0ms |
| Deduplicating fonts | 0 deduplicated | 0ms |
...
| Subsetting fonts | 0 subsetted | 0ms |
| Deduplicating objects | 1 deduplicated | 1ms |
| Deduplicating fonts | 0 deduplicated | 0ms |
...
**Input:** 156.0 KB | **Output:** 139.7 KB | **Saved:** 10.4% (16.3 KB) | **Time:** 8ms
**Detected traits:** Tagged, StructTree, Lang=en-US
...
**Input:** 156.0 KB | **Output:** 20.0 KB | **Saved:** 87.2% (136.0 KB) | **Time:** 37ms
**Detected traits:** Tagged, StructTree, Lang=en-US
...
| Recompressing images | 2 converted | 28ms |
| Unembedding standard fonts | 4 unembedded | 0ms |
| Subsetting fonts | 0 subsetted | 0ms |
| Deduplicating objects | 8 deduplicated | 0ms |
| Deduplicating fonts | 0 deduplicated | 0ms |
